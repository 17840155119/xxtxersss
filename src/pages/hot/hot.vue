...
import { getHotRecommemdAPI } from '@/services/hot'
...
// 获取热门推荐数据
const getHotRecommemdData = async () => {
  const res = await getHotRecommemdAPI(currUrlMap!.url, {
    // 技巧：环境变量，开发环境，修改初始页面方便测试页面结束
